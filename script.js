document.getElementById("form-conversor").addEventListener("submit", function(event) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            document.getElementById("res").innerHTML = `Resultado: ${resultado.toFixed(2)} ${moedaDestino}`;
        })
        .catch(error => {
